...
const ToggleRoot = forwardRef<ElementRef<typeof Pressable>, ComponentPropsWithoutRef<typeof Pressable> & {
  pressed: boolean;
  onPressedChange: (pressed: boolean) => void;
  disabled?: boolean;
}>(
  ({ pressed, onPressedChange, disabled, onPress: onPressProp, ...props }, ref) => {
...
const Toggle = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ToggleRoot> & VariantProps<typeof toggleVariants>
